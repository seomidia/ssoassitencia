<div class="col-md-12">
    <div class="row">
        <div class="form-group col-md-4">
            ...
            <select class="form-control form-control-sm" aria-label=".form-select-sm example" onchange="getServicos(this)">
        ...
        <div class="form-group col-md-4" id="consultas" style="display: none">
            <label> Serviço</label>
            <select class="form-control form-control-sm" aria-label=".form-select-sm example" onchange="risco(this)">
                <option value="" selected>Selecione</option>
            </select>
        </div>
